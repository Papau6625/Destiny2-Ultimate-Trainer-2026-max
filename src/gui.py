...
log = logging.getLogger("Destiny2-Ultimate-Trainer-2026-max.GUI")

class TrainerGUI(ctk.CTk):
    def __init__(self, trainer: GameTrainer):
        super().__init__()
        self.trainer = trainer
        self.title("Destiny2-Ultimate-Trainer-2026-max 1.5.0")
    ...
    def create_widgets(self):
        ctk.CTkLabel(self, text="Destiny2-Ultimate-Trainer-2026-max", font=("Segoe UI", 24, "bold")).pack(pady=20)
        ...
        feature_names = ['godmode', 'ammo_hack', 'esp_hack', 'speedhack', 'norecoil', 'loot_all', 'bounty_hack', 'aim_assist']
...
def create_tray_icon(gui):
    ...
    return pystray.Icon("trainer", img, "Destiny2-Ultimate-Trainer-2026-max", menu)
