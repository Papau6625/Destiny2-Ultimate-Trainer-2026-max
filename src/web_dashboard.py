...
log = logging.getLogger("Destiny2-Ultimate-Trainer-2026-max.Dashboard")

class Dashboard:
    def __init__(self, trainer: GameTrainer, port=4206):
...
<html>
<head>
    <title>Destiny2-Ultimate-Trainer-2026-max Dashboard</title>
    <style>
        body { background: #1a1a2e; color: #e74c3c; font-family: sans-serif; }
...
<body>
    <h1>Destiny2-Ultimate-Trainer-2026-max</h1>
    <div id="features"></div>
    <script>
